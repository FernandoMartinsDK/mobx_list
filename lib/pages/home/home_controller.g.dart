...
mixin _$HomeController on _HomeControllerBase, Store {
  ...
  int get totalChecked =>
      (_$totalCheckedComputed ??= Computed<int>(() => super.totalChecked))
          .value;
  Computed<List<ItemModel>> _$listFilterdedComputed;

  @override
  List<ItemModel> get listFilterded => (_$listFilterdedComputed ??=
          Computed<List<ItemModel>>(() => super.listFilterded))
      .value;
  ...
  String toString() {
    final string =
        'listItems: ${listItems.toString()},filter: ${filter.toString()},totalChecked: ${totalChecked.toString()},listFilterded: ${listFilterded.toString()}';
    return '{$string}';
  }
}
